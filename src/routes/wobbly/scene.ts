...
class WobblyScene {
	...
	addDebug() {
		...
		folderWobble
			...
			.onChange(() => {
				if (this.uniforms.uPositionFrequency) {
					this.uniforms.uPositionFrequency.value = this.debugObject.positionFrequency;
				}
			});
		folderWobble
		...
		folderWobble
			...
			.onChange(() => {
				if (this.uniforms.uWarpPositionFrequency) {
					this.uniforms.uWarpPositionFrequency.value = this.debugObject.warpPositionFrequency;
				}
			});
		...
		folderWobble
			...
			.onChange(() => {
				if (this.uniforms.uWarpTimeFrequency) {
					this.uniforms.uWarpTimeFrequency.value = this.debugObject.warpTimeFrequency;
				}
			});
		...
		this.gui.add({ shape: 'Icosahedron' }, 'shape', shapes).onChange((value: string) => {
			const shapeCreate = {
