...
class ParticlesInteractiveScene {
	...
	addDebug() {
		...
		this.gui
			...
			.onFinishChange(() => {
				if (this.fboMaterial)
					this.fboMaterial.uniforms.uForce.value = this.params.noiseForce
				if (this.material)
					this.material.uniforms.uForce.value = this.params.noiseForce
			})
		...
		this.gui
			...
			.onFinishChange(() => {
				...
				if (this.material)
					this.material.uniforms.uHoverRadius.value = this.params.hoverRadius
			})
		...
		this.gui
			...
			.onChange(() => {
				if (this.fboMaterial)
					this.fboMaterial.uniforms.uRadar.value = this.params.radar
				if (this.material)
					this.material.uniforms.uRadar.value = this.params.radar
			})
		...
		this.gui
			...
			.onFinishChange(() => {
				...
				if (this.material)
					this.material.uniforms.uRadarRadius.value = this.params.radarRadius
			})
	}
