...
<nav>
	<!-- samples list -->
	<ul>
		<li on:mouseenter={() => handleSampleChange(0)} class:active={scene?.index === 0}>Sample 1</li>
		<li on:mouseenter={() => handleSampleChange(1)} class:active={scene?.index === 1}>Sample 2</li>
		<li on:mouseenter={() => handleSampleChange(2)} class:active={scene?.index === 2}>Sample 3</li>
	</ul>
</nav>
